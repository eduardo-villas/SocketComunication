...
public class MyLogger extends Logger {
  ...
  */
   ...
   * <p>
   * The {@link #getName MyLogger.getName()} method for the root logger always returns
   * string value: "root". However, calling
   * <code>MyLogger.getLogger("root")</code> does not retrieve the root
  ...
  Logger getRootLogger() {
    return new MyLogger(LogManager.getRootLogger().getName());
  }
  ...
  Logger getLogger(String name, LoggerFactory factory) {
    return new MyLogger(LogManager.getLogger(name, factory).getName());
  }
